...
public class GamePanel extends JLayeredPane {
    ...
    final JLabel backgroundGrid = new JLabel();
    final JPanel endScreen = new JPanel();
    final ImageIcon grid = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("grid.png")));
    final ImageIcon imageX = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("X.png")));
    final Image image = imageX.getImage();
    final Image newImg = image.getScaledInstance(180, 180, java.awt.Image.SCALE_SMOOTH);
    final ImageIcon smallX = new ImageIcon(newImg); // i stole this from Stack Overflow.
    final ImageIcon imageO = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("O.png")));
    final Image image2 = imageO.getImage();
    final Image newImg2 = image2.getScaledInstance(180, 180, java.awt.Image.SCALE_SMOOTH);
    final ImageIcon smallO = new ImageIcon(newImg2);
    final JLabel oWinText = new JLabel("O WINS");
    final JLabel xWinText = new JLabel("X WINS");
    final JLabel drawText = new JLabel("DRAW");
    final JLabel x1 = new JLabel(smallX);
    final JLabel x2 = new JLabel(smallX);
    final JLabel x3 = new JLabel(smallX);
    final JLabel x4 = new JLabel(smallX);
    final JLabel x5 = new JLabel(smallX);
    final JLabel x6 = new JLabel(smallX);
    final JLabel x7 = new JLabel(smallX);
    final JLabel x8 = new JLabel(smallX);
    final JLabel x9 = new JLabel(smallX);
    final JLabel o1 = new JLabel(smallO);
    final JLabel o2 = new JLabel(smallO);
    final JLabel o3 = new JLabel(smallO);
    final JLabel o4 = new JLabel(smallO);
    final JLabel o5 = new JLabel(smallO);
    final JLabel o6 = new JLabel(smallO);
    final JLabel o7 = new JLabel(smallO);
    final JLabel o8 = new JLabel(smallO);
    final JLabel o9 = new JLabel(smallO);
    ...
    void guiUpdate() {
        ...
        for (char mark : Board.getGameBoard()) {
            if (mark == 'X') {
                switch (index) {
                    case 1 -> x1.setVisible(true);
                    case 2 -> x2.setVisible(true);
                    case 3 -> x3.setVisible(true);
                    case 4 -> x4.setVisible(true);
                    case 5 -> x5.setVisible(true);
                    case 6 -> x6.setVisible(true);
                    case 7 -> x7.setVisible(true);
                    case 8 -> x8.setVisible(true);
                    case 9 -> x9.setVisible(true);
                }
            } else if (mark == 'O') {
                switch (index) {
                    case 1 -> o1.setVisible(true);
                    case 2 -> o2.setVisible(true);
                    case 3 -> o3.setVisible(true);
                    case 4 -> o4.setVisible(true);
                    case 5 -> o5.setVisible(true);
                    case 6 -> o6.setVisible(true);
                    case 7 -> o7.setVisible(true);
                    case 8 -> o8.setVisible(true);
                    case 9 -> o9.setVisible(true);
                }
            }
            index++;
        }
